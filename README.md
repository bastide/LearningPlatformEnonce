...
- Fournir le diagramme de classes UML mis à jour pour refléter ces nouvelles spécifications, ([fichier StarUML dans le dossier doc](./doc/mooc.mdj)), barème indicatif 4 points). Faire apparaître sur le diagramme les méthodes, classes et associations ajoutées.
